...
function peg$parse(input, options) {
  ...
  var peg$f5 = function(statements) { return createNode('block', { statements: statements}) };
  var peg$f6 = function(condition, nonDeclarativeStatementTrue, nonDeclarativeStatementElse) { return { nonDeclarativeStatementFalse: nonDeclarativeStatementElse } };
  var peg$f7 = function(condition, nonDeclarativeStatementTrue, statementFalse) { return createNode('if', { logicalExpression: condition, statementTrue: nonDeclarativeStatementTrue, statementFalse: statementFalse?.nonDeclarativeStatementElse})};
  var peg$f8 = function(condition, nonDeclarativeStatementTrue) { return createNode('while', { logicalExpression: condition, statementTrue: nonDeclarativeStatementTrue })};
  var peg$f9 = function(init, logicalCondition, incrementalExpression, statement) { 
  ...
  var peg$f18 = function(id, assignment) { return createNode('assignment', { id: id, expression: assignment }) };
  var peg$f19 = function(expressionLeft, operator, expressionRight) { return {type: operator, expressionRight: expressionRight }};
  var peg$f20 = function(expressionLeft, expanssion) { return expanssion.reduce(
  ...
  var peg$f21 = function(left, operator, right) { return { type: operator, right: right } };
  var peg$f22 = function(left, expansion) {
  ...
  var peg$f23 = function(left, operator, right) { return { type:operator, right } };
  var peg$f24 = function(left, expansion) {
  ...
  var peg$f25 = function(num) { return createNode('unary', { operator: "-", expression: num }) };
  var peg$f26 = function(calle, args) { return args || []};
  var peg$f27 = function(calle, parameters) {
  ...
  var peg$f28 = function(nonDeclarativeStatement, nonDeclarativeStatementExtension) {return nonDeclarativeStatementExtension};
  var peg$f29 = function(nonDeclarativeStatement, nonDeclarativeStatements) { 
    return [nonDeclarativeStatement, ...nonDeclarativeStatements] 
};
  var peg$f30 = function() { return createNode('literal', { value: parseFloat(text(), 10)}) };
  var peg$f31 = function(exp) { return createNode('parenthesis', { expression: exp}) };
  var peg$f32 = function(id) { return createNode('variableReference', { id: id}) };
