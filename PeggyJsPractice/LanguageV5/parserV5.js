...
function peg$parse(input, options) {
  ...
  var peg$f11 = function(declaration) { return declaration };
  var peg$f12 = function(expression) { return expression };
  var peg$f13 = function() { return null };
  var peg$f14 = function() { return text() };
  var peg$f15 = function(id, assignment) { return createNode('assignment', { id: id, expression: assignment }) };
  var peg$f16 = function(expressionLeft, operator, expressionRight) { return {type: operator, expressionRight: expressionRight }};
  var peg$f17 = function(expressionLeft, expanssion) { return expanssion.reduce(
  ...
  var peg$f18 = function(left, operator, right) { return { type: operator, right: right } };
  var peg$f19 = function(left, expansion) {
  ...
  var peg$f20 = function(left, operator, right) { return { type:operator, right } };
  var peg$f21 = function(left, expansion) {
  ...
  var peg$f22 = function(num) { return createNode('unary', { operator: "-", expression: num }) };
  var peg$f23 = function() { return createNode('literal', { value: parseFloat(text(), 10)}) };
  var peg$f24 = function(exp) { return createNode('parenthesis', { expression: exp}) };
  var peg$f25 = function(id) { return createNode('variableReference', { id: id}) };
