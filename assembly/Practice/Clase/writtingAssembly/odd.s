...
li a2, 0
li a7, 2  
# todo bien ecall 34.567
# ecall


# fa0 contains number(constant), fa1 is a copy of fa0, fa2 is fa0 with .0 decimal 
fmv.s fa1, fa0
# fvm.s fa0, fa1 todo bien con fa1 34.567
# ecall
 
getNextDecimalChar: 
fcvt.w.s a4, fa1
# li a7, 1 ESTE PRINT TODO BIEN 35 34567.0
# mv a0, a4
# ecall
# check if number was rounded up 
fcvt.s.w fa5, a4
# li a7, 2 ESTE PRINT TODO BIEN 35.0
# fmv.s fa0, fa5
# ecall
fle.s a0, fa5, fa1
...
# li a7, 1
# mv a0, a4
# ecall # ESTE PRINT TODO BIEN 34
mul a4, a4, a3
# mv a0, a4
# ecall # ESTE PRINT TODO BIEN 340
# move decimal point to the right one time 
fmul.s fa1, fa1, fa3
# li a7, 2
# fmv.s fa0, fa1
# ecall # ESTE PRINT TODO BIEN 345.67
# turn FA1 to int, check if it was not rounded up 
fcvt.w.s a5, fa1
# li a7, 1
# mv a0, a5
# ecall # ESTE PRINT TODO BIEN 346
# check if number was rounded up 
fcvt.s.w fa5, a5
# li a7, 2
# fmv.s fa0, fa5
# ecall #  debe imprimir 346.0
fle.s a0, fa5, fa1
...
# li a7, 1
# mv a0, a6
# ecall # siguiente digito 5
 
# A6 contains next digit, save it---- 
# augment counter by 1 
addi a1, a1, 1
# 48 ASCII is number 0 
addi a0, a0, 48  #  el problema esta aca estaba anadiendo
sb a0, 0(t6)
addi t6, t6, 1
